package com.localappmerchant.travelmantics.utils.db;
...
public class FirebaseUtil {
    ...
    public static ArrayList<TravelDeal> tDeals;
    ...
    public static void openFBReference(String ref, final ListActivity callerActivity) {
        ...
        tDeals = new ArrayList<TravelDeal>();
        mDatabaseReference = mFirebaseDatabase.getReference().child(ref);
    }

    public static void attachFirebaseAuthListener(){
    ...
    private static void checkAdmin(String uid){
        ...
        ChildEventListener listener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                Log.d("Admin", " This user is an administrator");
                mActivity.showMenu();
            }
